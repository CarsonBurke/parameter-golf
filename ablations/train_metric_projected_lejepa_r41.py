"""
LeJEPA r41: sharpened live geometric target matching over the full vocabulary.
...
Observed r40 failure and r41 hypothesis:
...
def main() -> None:
    ...
    log0(
        ...
        f"head=sharpened_live_geometric_target_xent"
    )
    log0(
