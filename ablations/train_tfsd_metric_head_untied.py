"""
Muon-baseline ablation with an untied deployed TFSD metric decoder.
...
class UntiedTFSDMetricHeadGPT(base.GPT):
...
def main() -> None:
    ...
    base_model = UntiedTFSDMetricHeadGPT(args).to(device).bfloat16()
    ...
    log0(
        f"metric_head_untied:tfsd_weight={args.tfsd_weight} metric_ce_weight={args.metric_ce_weight} "
