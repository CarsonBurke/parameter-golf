...
class Hyperparameters:
    ...
    rope_dims = int(os.environ.get("ROPE_DIMS", 16))  # partial RoPE: 16 of 64 head dims
...
class CausalSelfAttention(nn.Module):
    def __init__(
        ...
        self.rope_dims = 0  # set by GPT.__init__ from args
...
def main() -> None:
    ...
    if args.rope_dims > 0:
        ...
        for block in base_model.blocks:
            ...
            block.attn.rotary = Rotary(head_dim, base=args.rope_base, rope_dims=args.rope_dims)
